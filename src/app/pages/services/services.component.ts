...
export class ServiceComponent {
  services = [
    ...
    { title: 'Cloud App Development',  description: 'From concept to deployment, our cloud application development services ensure your business adapts and flourishes in the digital ecosystem,increasing efficiency and sinnovation.', icon: './assets/logo/2.svg',route: '/cloudapp'},
    ...
    { title: 'UI/UX Designing', description: 'We fashion intuitive and visually appealing interfaces that provide a seamless user experience,ensuring your applications are both functional and engaging.', icon: './assets/logo/5.svg',route: '/ui' },
