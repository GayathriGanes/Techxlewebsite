...
export class SolutionsComponent {
  ...
  services = [
    ...
    { name: 'Review Board Management', image: './assets/images/bn1.png', isHovered: false,route:'/review-board-management' },
    { name: 'Grant Applications', image: './assets/images/bn2.png', isHovered: false,route:'/grant-applications' },
