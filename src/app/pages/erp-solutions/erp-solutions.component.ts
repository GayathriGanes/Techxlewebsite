...
@Component({
  ...
  styleUrl: './erp-solutions.component.css'
})
export class ErpSolutionsComponent {
 @ViewChild('container', { read: ElementRef }) container!: ElementRef;
  services = [
    ...
    { name: 'LabAx LIMS', image: './assets/images/m20.png', isHovered: false,route:'/solutions/labax-lims' },
    { name: 'ERP Solutions', image: './assets/images/m21.png', isHovered: false,route:'/solutions/erp-solutions' },
  ];
  hoverIn(service:any) {
